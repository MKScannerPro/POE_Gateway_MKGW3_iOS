...
@interface MKGWPirController ()<UITableViewDelegate,
...
@implementation MKGWPirController

- (void)dealloc {
    NSLog(@"MKGWPirController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 3 && indexPath.row == 0) {
        //PIR sensor data
        MKGWPirSensorDataController *vc = [[MKGWPirSensorDataController alloc] init];
    ...
    if (indexPath.section == 3 && indexPath.row == 1) {
        ...
        MKGWPirSensorParamsController *vc = [[MKGWPirSensorParamsController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 3 && indexPath.row == 2) {
        ...
        MKGWPirAdvParamsController *vc = [[MKGWPirAdvParamsController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
