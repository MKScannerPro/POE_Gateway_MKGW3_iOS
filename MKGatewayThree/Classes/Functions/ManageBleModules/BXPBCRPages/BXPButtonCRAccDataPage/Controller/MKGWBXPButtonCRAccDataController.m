//
//  MKGWBXPButtonCRAccDataController.m
...
@interface MKGWBXPButtonCRAccDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPButtonCRAccDataController

- (void)dealloc {
    NSLog(@"MKGWBXPButtonCRAccDataController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_bxpBtnCRNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
