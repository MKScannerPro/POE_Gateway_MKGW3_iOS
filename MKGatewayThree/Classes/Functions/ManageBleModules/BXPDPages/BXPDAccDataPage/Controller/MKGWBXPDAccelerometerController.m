//
//  MKGWBXPDAccelerometerController.m
...
@interface MKGWBXPDAccelerometerController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPDAccelerometerController

- (void)dealloc {
    NSLog(@"MKGWBXPDAccelerometerController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_bxpBXPDNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
