//
//  MKGWBXPSHistoricalTHDataPageModel.m
...
@implementation MKGWBXPSHistoricalTHDataPageModel

- (void)dealloc {
    NSLog(@"MKGWBXPSHistoricalTHDataPageModel销毁");
...
- (void)deleteHistoricalHTDataWithSucBlock:(void (^)(void))sucBlock
                               failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_bxpBXPSDeleteHistoricalHTDataWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                       macAddress:[MKScannerDeviceModelManager shared].macAddress
                                                            topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                                         sucBlock:^(id  _Nonnull returnData) {
        if (sucBlock) {
