...
@interface MKGWButtonDFUController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWButtonDFUModel *dataModel;
...
@implementation MKGWButtonDFUController

- (void)dealloc {
    NSLog(@"MKGWButtonDFUController销毁");
...
- (MKGWButtonDFUModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWButtonDFUModel alloc] init];
