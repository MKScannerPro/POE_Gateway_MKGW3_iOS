...
@implementation MKGWBXPCAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGWBXPCAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGWMQTTInterface gw_bxpBXPCNotifyAccDataWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                  notify:isOn
