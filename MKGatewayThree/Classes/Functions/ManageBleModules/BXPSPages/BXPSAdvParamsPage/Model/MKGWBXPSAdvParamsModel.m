...
@interface MKGWBXPSAdvParamsModel ()
...
- (BOOL)readBXPSAdvParams:(NSString *)bleMac {
    ...
    [MKGWMQTTInterface gw_readBXPSAdvParamsWithBleMacAddress:bleMac macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
