...
@interface MKGWFilterByMacController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWFilterByMacModel *dataModel;

@end

@implementation MKGWFilterByMacController
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWFilterByMacController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWFilterByMacModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWFilterByMacModel alloc] init];
    }
    return _dataModel;
}
