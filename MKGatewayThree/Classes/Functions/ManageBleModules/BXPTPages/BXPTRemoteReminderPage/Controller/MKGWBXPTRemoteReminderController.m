//
//  MKGWBXPTRemoteReminderController.m
...
@interface MKGWBXPTRemoteReminderController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWBXPTRemoteReminderModel *dataModel;

@end

@implementation MKGWBXPTRemoteReminderController

- (void)dealloc {
    NSLog(@"MKGWBXPTRemoteReminderController销毁");
}
...
- (MKGWBXPTRemoteReminderModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWBXPTRemoteReminderModel alloc] init];
    }
    return _dataModel;
}
