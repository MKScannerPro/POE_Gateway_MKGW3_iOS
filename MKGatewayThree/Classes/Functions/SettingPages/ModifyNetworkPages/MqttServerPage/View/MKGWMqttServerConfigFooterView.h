//
//  MKGWMqttServerConfigFooterView.h
...
@interface MKGWMqttServerConfigFooterViewModel : NSObject
...
@protocol MKGWMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKGWMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKGWMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKGWMqttServerConfigFooterViewDelegate>delegate;
