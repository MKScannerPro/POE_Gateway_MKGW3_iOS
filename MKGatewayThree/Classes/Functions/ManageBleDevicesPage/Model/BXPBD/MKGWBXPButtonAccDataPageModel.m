//
//  MKGWBXPButtonAccDataPageModel.m
...
@implementation MKGWBXPButtonAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGWBXPButtonAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGWMQTTInterface gw_bxpBtnNotifyAccDataWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                 notify:isOn
