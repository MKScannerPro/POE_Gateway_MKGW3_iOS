//
//  MKGWConnectedDeviceWriteAlertView.m
...
@interface MKGWConnectedDeviceWriteAlertView ()
...
@implementation MKGWConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKGWConnectedDeviceWriteAlertView销毁");
}
