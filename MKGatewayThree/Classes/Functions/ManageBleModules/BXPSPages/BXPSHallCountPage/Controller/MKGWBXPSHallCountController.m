...
@interface MKGWBXPSHallCountController ()<UITableViewDelegate,
...
@implementation MKGWBXPSHallCountController

- (void)dealloc {
    NSLog(@"MKGWBXPSHallCountController销毁");
}
...
- (void)gw_pressEventCountCell_clearButtonPressed:(NSInteger)index {
    ...
    [MKGWMQTTInterface gw_clearBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)readDatasFromDevice {
    ...
    [MKGWMQTTInterface gw_readBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
