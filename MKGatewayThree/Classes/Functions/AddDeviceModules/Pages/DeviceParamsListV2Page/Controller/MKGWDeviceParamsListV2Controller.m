//
//  MKGWDeviceParamsListV2Controller.m
...
@interface MKGWDeviceParamsListV2Controller ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKGWDeviceParamsListV2Controller

- (void)dealloc {
    NSLog(@"MKGWDeviceParamsListV2Controller销毁");
...
- (void)viewDidLoad {
    ...
    [MKGWDeviceMQTTParamsModel shared].deviceModel.deviceType = @"01";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        //Network Settings
        MKGWBleNetworkSettingsV2Controller *vc = [[MKGWBleNetworkSettingsV2Controller alloc] init];
    ...
    if (indexPath.section == 1 && indexPath.row == 2) {
        //Advertise iBeacon
        MKGWBleAdvBeaconV2Controller *vc = [[MKGWBleAdvBeaconV2Controller alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 1 && indexPath.row == 3) {
        //Device Information
        MKGWBleDeviceInfoV2Controller *vc = [[MKGWBleDeviceInfoV2Controller alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
}
