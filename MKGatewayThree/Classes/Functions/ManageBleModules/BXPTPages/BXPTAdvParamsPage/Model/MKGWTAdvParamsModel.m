...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGWMQTTInterface gw_readBXPTAdvParamsWithBleMacAddress:bleMac macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
