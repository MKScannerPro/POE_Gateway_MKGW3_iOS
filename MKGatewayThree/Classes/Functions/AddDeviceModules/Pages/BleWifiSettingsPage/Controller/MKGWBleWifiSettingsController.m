//
//  MKGWBleWifiSettingsController.m
...
@interface MKGWBleWifiSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWBleWifiSettingsModel *dataModel;

@end

@implementation MKGWBleWifiSettingsController

- (void)dealloc {
    NSLog(@"MKGWBleWifiSettingsController销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    if (section == 0 || section == 1 || section == 12 || section == 14) {
        return 10.f;
    }
    return 0.f;
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWBleWifiSettingsController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWBleWifiSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWBleWifiSettingsModel alloc] init];
    }
    return _dataModel;
}
