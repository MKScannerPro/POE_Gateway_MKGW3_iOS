...
@interface MKGWBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKGWBleDeviceInfoModel *dataModel;

@end

@implementation MKGWBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKGWBleDeviceInfoController销毁");
...
- (void)loadSectionDatas {
    ...
    cellModel8.leftMsg = @"Ethernet MAC";
    cellModel8.rightMsg = self.dataModel.ethernetMac;
...
- (MKGWBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
