...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed {
    ...
    [MKGWMQTTInterface gw_bxpBXPCNotifyAccDataWithBleMac:self.bleMac notify:YES macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
