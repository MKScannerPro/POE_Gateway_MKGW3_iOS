...
@interface MKGWBleDeviceInfoModel ()
...
@implementation MKGWBleDeviceInfoModel
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKGWInterface gw_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
