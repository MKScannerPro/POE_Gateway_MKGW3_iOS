...
@implementation MKGWMqttServerLwtViewModel
@end

@interface MKGWMqttServerLwtView ()
...
@implementation MKGWMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchSelectedIcon.png") : LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchSelectedIcon.png") : LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKGWMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGWMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewayThree", @"MKGWMqttServerLwtView", @"gw_switchUnselectedIcon.png") forState:UIControlStateNormal];
