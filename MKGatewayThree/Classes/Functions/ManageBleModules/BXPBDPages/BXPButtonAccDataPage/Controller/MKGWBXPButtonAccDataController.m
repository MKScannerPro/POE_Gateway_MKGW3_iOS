...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed {
    ...
    [MKGWMQTTInterface gw_bxpBtnNotifyAccDataWithBleMac:self.bleMac notify:YES macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
