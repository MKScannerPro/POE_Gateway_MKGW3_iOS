//
//  MKGWManageBleDevicesController.m
...
@interface MKGWManageBleDevicesController ()<UITableViewDelegate,
...
@implementation MKGWManageBleDevicesController

- (void)dealloc {
    NSLog(@"MKGWManageBleDevicesController销毁");
...
- (void)mk_scanner_manageBleDevicesCellConnectButtonPressed:(NSString *)macAddress typeCode:(NSInteger)typeCode; {
    if (typeCode == 7) {
        ...
        MKAlertViewAction *confirmAction = [[MKAlertViewAction alloc] initWithTitle:@"OK" handler:^{
            ...
            [self connectPeripheral:macAddress
                               type:MKGWManageBleDevicesTypeBXPBD
    ...
    //Normal
    [self connectPeripheral:macAddress
                       type:MKGWManageBleDevicesTypeOther
                   password:self.asciiText];
}
