...
@interface MKGWBXPButtonAdvParamsModel ()
...
@implementation MKGWBXPButtonAdvParamsModel
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGWMQTTInterface gw_bxpBtnReadAdvParamsWithBleMac:bleMac macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
