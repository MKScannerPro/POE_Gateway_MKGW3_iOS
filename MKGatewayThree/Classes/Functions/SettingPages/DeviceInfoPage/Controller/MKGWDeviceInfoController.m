...
@property (nonatomic, strong)MKGWDeviceInfoModel *dataModel;

@end

@implementation MKGWDeviceInfoController

- (void)dealloc {
    NSLog(@"MKGWDeviceInfoController销毁");
}
...
- (MKGWDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
