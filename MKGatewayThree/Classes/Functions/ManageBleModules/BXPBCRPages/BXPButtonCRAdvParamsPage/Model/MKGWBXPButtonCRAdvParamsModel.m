...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGWMQTTInterface gw_bxpBtnCRReadAdvParamsWithBleMac:bleMac macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
