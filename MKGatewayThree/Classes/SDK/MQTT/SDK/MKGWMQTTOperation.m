...
/**
 线程ID
 */
@property (nonatomic, assign)mk_gw_serverOperationID operationID;
...
@implementation MKGWMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKGWMQTTOperation销毁");
}
...
#pragma mark - MKGWMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKGWMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_gw_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_gw_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
