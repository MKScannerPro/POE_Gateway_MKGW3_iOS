...
@interface MKGWDeviceModeManager : NSObject

+ (MKGWDeviceModeManager *)shared;
...
- (void)addDeviceModel:(id <MKGWDeviceModeManagerDataProtocol>)protocol;
