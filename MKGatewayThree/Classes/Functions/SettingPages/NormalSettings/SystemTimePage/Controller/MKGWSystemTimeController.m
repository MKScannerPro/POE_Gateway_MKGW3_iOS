...
@interface MKGWSystemTimeController ()<UITableViewDelegate,
UITableViewDataSource,
MKGWSystemTimeCellDelegate,
...
@implementation MKGWSystemTimeController

- (void)dealloc {
    NSLog(@"MKGWSystemTimeController销毁");
    if (self.readTimer) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0)  {
        //Sync Time From NTP
        MKGWNTPServerController *vc = [[MKGWNTPServerController alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        MKGWSystemTimeCell *cell = [MKGWSystemTimeCell initCellWithTableView:tableView];
...
#pragma mark - MKGWSystemTimeCellDelegate
...
- (void)loadSection1Datas {
    MKGWSystemTimeCellModel *cellModel = [[MKGWSystemTimeCellModel alloc] init];
    cellModel.index = 0;
