...
@implementation MKGWAdvTriggerCellModel
@end

@interface MKGWAdvTriggerCell ()
...
@implementation MKGWAdvTriggerCell

+ (MKGWAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKGWAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGWAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKGWAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGWAdvTriggerCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKGWAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGWAdvTriggerCellModel.class]) {
        return;
    }
