...
@implementation MKGWTofAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGWTofAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGWMQTTInterface gw_bxpMKTofNotifyAccDataWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                   notify:isOn
