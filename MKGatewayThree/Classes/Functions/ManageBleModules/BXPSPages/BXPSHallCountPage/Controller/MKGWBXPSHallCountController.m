...
- (void)gw_pressEventCountCell_clearButtonPressed:(NSInteger)index {
    ...
    [MKGWMQTTInterface gw_clearBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)readDatasFromDevice {
    ...
    [MKGWMQTTInterface gw_readBXPSHallCountWithBleMacAddress:self.bleMac macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
