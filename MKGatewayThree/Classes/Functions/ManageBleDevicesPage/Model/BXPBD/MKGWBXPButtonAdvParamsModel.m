...
- (void)readAdvParamsWithSucBlock:(void (^)(NSArray *dataList))sucBlock
    ...
    [MKGWMQTTInterface gw_bxpBtnReadAdvParamsWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
...
- (void)configAdvParams:(NSDictionary *)params
            ...
            failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_bxpBtnConfigAdvParamsWithParams:params
