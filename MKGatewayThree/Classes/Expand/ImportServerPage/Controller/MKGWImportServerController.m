...
@interface MKGWImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKGWImportServerController

- (void)dealloc {
    NSLog(@"MKGWImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(gw_selectedServerParams:)]) {
        [self.delegate gw_selectedServerParams:model.leftMsg];
    }
