...
@implementation MKGWSettingController

- (void)dealloc {
    NSLog(@"MKGWSettingController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWSettingController", @"gw_editIcon.png") forState:UIControlStateNormal];
