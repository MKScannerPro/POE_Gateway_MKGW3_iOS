...
@interface MKGWDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGWDataReportModel *dataModel;

@end

@implementation MKGWDataReportController

- (void)dealloc {
    NSLog(@"MKGWDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWDataReportController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWDataReportModel alloc] init];
    }
    return _dataModel;
}
