//
//  MKGWServerConfigDeviceFooterView.h
...
@interface MKGWServerConfigDeviceFooterViewModel : NSObject
...
@protocol MKGWServerConfigDeviceFooterViewDelegate <NSObject>
...
@interface MKGWServerConfigDeviceFooterView : UIView

@property (nonatomic, strong)MKGWServerConfigDeviceFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKGWServerConfigDeviceFooterViewDelegate>delegate;
