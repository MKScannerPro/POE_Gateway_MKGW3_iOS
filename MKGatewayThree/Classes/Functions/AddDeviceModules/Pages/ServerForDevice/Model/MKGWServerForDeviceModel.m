...
@interface MKGWServerForDeviceModel ()
...
@implementation MKGWServerForDeviceModel
...
- (void)updateValue:(MKGWServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKGWServerForDeviceModel.class]) {
        return;
    }
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configHost {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerHost:self.host sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKGWInterface gw_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKGWInterface gw_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKGWInterface gw_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKGWInterface gw_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKGWInterface gw_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKGWInterface gw_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKGWInterface gw_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKGWInterface gw_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readLWTStatus {
    __block BOOL success = NO;
    [MKGWInterface gw_readLWTStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTStatus {
    __block BOOL success = NO;
    [MKGWInterface gw_configLWTStatus:self.lwtStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTQos {
    __block BOOL success = NO;
    [MKGWInterface gw_readLWTQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTQos {
    __block BOOL success = NO;
    [MKGWInterface gw_configLWTQos:self.lwtQos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTRetain {
    __block BOOL success = NO;
    [MKGWInterface gw_readLWTRetainWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTRetain {
    __block BOOL success = NO;
    [MKGWInterface gw_configLWTRetain:self.lwtRetain sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTTopic {
    __block BOOL success = NO;
    [MKGWInterface gw_readLWTTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTTopic {
    ...
    [MKGWInterface gw_configLWTTopic:topic sucBlock:^{
        success = YES;
        self.lwtTopic = topic;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)readLWTPayload {
    __block BOOL success = NO;
    [MKGWInterface gw_readLWTPayloadWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTPayload {
    __block BOOL success = NO;
    [MKGWInterface gw_configLWTPayload:self.lwtPayload sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKGWInterface gw_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_gw_connectMode mode = mk_gw_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_gw_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_gw_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_gw_connectMode_SelfSignedCertificates;
        }
    }
    [MKGWInterface gw_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKGWInterface gw_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKGWInterface gw_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKGWInterface gw_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
