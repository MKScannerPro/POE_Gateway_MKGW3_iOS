//
//  MKGWBXPCHistoricalTHDataHeaderView.m
...
@interface MKGWBXPCHistoricalTHDataHeaderView ()
...
@implementation MKGWBXPCHistoricalTHDataHeaderView
...
- (void)deleteButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gw_bxpcHistoricalHTDataHeaderView_deleteButtonPressed)]) {
        [self.delegate gw_bxpcHistoricalHTDataHeaderView_deleteButtonPressed];
    }
}
...
- (UIImageView *)synIcon {
    if (!_synIcon) {
        ...
        _synIcon.image = LOADICON(@"MKGatewayThree", @"MKGWBXPCHistoricalTHDataHeaderView", @"gw_threeAxisAcceLoadingIcon.png");
    }
    return _synIcon;
}
...
- (UIButton *)exportButton {
    if (!_exportButton) {
        ...
        [_exportButton setImage:LOADICON(@"MKGatewayThree", @"MKGWBXPCHistoricalTHDataHeaderView", @"gw_slotExportEnableIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:LOADICON(@"MKGatewayThree", @"MKGWBXPCHistoricalTHDataHeaderView", @"gw_slotExportDeleteIcon.png") forState:UIControlStateNormal];
