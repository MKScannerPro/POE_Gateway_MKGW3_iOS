//
//  MKGWConnectSuccessController.m
...
@interface MKGWConnectSuccessController ()
...
@implementation MKGWConnectSuccessController

- (void)dealloc {
    NSLog(@"MKGWConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKGWDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_gw_addNewDeviceSuccessNotification"
                                                            object:nil
