...
@implementation MKGWBXPCAdvParamsModel
...
- (void)readAdvParamsWithSucBlock:(void (^)(NSArray *dataList))sucBlock
    ...
    [MKGWMQTTInterface gw_readBXPCAdvParamsWithBleMacAddress:[MKGWManageBleDevicesManager shared].bleMac
...
- (void)configAdvParamsWithChannel:(NSInteger)channel
                       ...
                       failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_configBXPCAdvParamsWithChannel:channel
                                                interval:interval
                                                 txPower:txPower
