//
//  MKGWBXPCRealTimeTHDataController.m
...
@interface MKGWBXPCRealTimeTHDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPCRealTimeTHDataController

- (void)dealloc {
    NSLog(@"MKGWBXPCRealTimeTHDataController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_bxpBXPCNotifyRealTimeHTDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
