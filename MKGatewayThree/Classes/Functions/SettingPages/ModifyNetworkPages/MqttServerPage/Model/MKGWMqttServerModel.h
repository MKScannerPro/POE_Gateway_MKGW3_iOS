...
@interface MKGWMqttServerModel : NSObject<MKGWExcelDeviceProtocol,
mk_gw_modifyMqttServerProtocol,
mk_gw_modifyMqttServerCertsProtocol>
...
/// 更新数据
/// @param model 数据源
- (void)updateValue:(MKGWMqttServerModel *)model;
