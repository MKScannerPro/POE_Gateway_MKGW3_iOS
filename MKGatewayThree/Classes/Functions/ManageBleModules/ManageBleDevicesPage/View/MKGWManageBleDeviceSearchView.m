//
//  MKGWManageBleDeviceSearchView.m
...
@interface MKGWManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKGWManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKGWManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKGWManageBleDeviceSearchView *view = [[MKGWManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKGatewayThree", @"MKGWManageBleDeviceSearchView", @"gw_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKGatewayThree", @"MKGWManageBleDeviceSearchView", @"gw_wifiGraySignalIcon.png");
    }
