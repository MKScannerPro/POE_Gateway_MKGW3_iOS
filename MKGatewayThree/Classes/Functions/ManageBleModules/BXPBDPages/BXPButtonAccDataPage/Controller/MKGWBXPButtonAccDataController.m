//
//  MKGWBXPButtonAccDataController.m
...
@interface MKGWBXPButtonAccDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPButtonAccDataController

- (void)dealloc {
    NSLog(@"MKGWBXPButtonAccDataController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_bxpBtnNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        ...
        if (isOn) {
            [[NSNotificationCenter defaultCenter] addObserver:self
                                                     selector:@selector(receiveAccDatas:)
                                                         name:MKGWReceiveBXPBtnAccDataNotification
                                                       object:nil];
        }else {
            [[NSNotificationCenter defaultCenter] removeObserver:self];
        }
