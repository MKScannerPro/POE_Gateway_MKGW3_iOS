...
@interface MKGWFilterByTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWFilterByTagModel *dataModel;

@end

@implementation MKGWFilterByTagController

- (void)dealloc {
    NSLog(@"MKGWFilterByTagController销毁");
}
...
- (MKGWFilterByTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWFilterByTagModel alloc] init];
    }
    return _dataModel;
}
