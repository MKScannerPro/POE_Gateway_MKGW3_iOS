//
//  MKGWMqttNetworkSettingsV2Controller.m
...
@interface MKGWMqttNetworkSettingsV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGWMqttNetworkSettingsV2Model *dataModel;

@end

@implementation MKGWMqttNetworkSettingsV2Controller

- (void)dealloc {
    NSLog(@"MKGWMqttNetworkSettingsV2Controller销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    if (self.dataModel.networkType != 1 && section == 1) {
        return 20.f;
    }
    if (self.dataModel.networkType != 0 && section == 3) {
        return 20.f;
    }
    return 0.f;
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWMqttNetworkSettingsV2Controller", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWMqttNetworkSettingsV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWMqttNetworkSettingsV2Model alloc] init];
    }
    return _dataModel;
}
