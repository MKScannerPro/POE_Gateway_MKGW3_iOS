//
//  MKGWServerConfigAppFooterView.h
...
@interface MKGWServerConfigAppFooterViewModel : NSObject
...
@protocol MKGWServerConfigAppFooterViewDelegate <NSObject>
...
@interface MKGWServerConfigAppFooterView : UIView

@property (nonatomic, strong)MKGWServerConfigAppFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKGWServerConfigAppFooterViewDelegate>delegate;
