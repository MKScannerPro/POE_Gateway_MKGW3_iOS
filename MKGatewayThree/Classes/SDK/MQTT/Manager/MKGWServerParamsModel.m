...
static NSString *const fileName = @"MKGWServerParams.txt";

@interface MKGWServerParamsModel ()
...
@implementation MKGWServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKGWServerParamsProtocol>)protocol {
