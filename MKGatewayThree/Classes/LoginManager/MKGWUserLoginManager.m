...
static MKGWUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKGWUserLoginManager ()
...
+ (MKGWUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKGWUserLoginManager new];
        }
    });
    return loginManager;
}
