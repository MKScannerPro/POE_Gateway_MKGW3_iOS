//
//  MKGWBXPSAccelerometerController.m
...
@interface MKGWBXPSAccelerometerController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPSAccelerometerController

- (void)dealloc {
    NSLog(@"MKGWBXPSAccelerometerController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed {
    ...
    [MKGWMQTTInterface gw_bxpBXPSNotifyAccDataWithBleMac:self.bleMac notify:YES macAddress:[MKGWDeviceModeManager shared].macAddress topic:[MKGWDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        [self.view showCentralToast:@"Success"];
        
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(receiveAccDatas:)
                                                     name:MKGWReceiveBXPSAccDataNotification
                                                   object:nil];
