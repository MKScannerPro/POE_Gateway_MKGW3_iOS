...
@interface MKGWNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGWNetworkStatusModel *dataModel;

@end

@implementation MKGWNetworkStatusController

- (void)dealloc {
    NSLog(@"MKGWNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWNetworkStatusController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
