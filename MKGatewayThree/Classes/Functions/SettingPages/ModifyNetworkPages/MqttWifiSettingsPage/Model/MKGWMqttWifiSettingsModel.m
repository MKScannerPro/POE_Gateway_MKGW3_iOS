...
@interface MKGWWifiNetworkSettingModel : NSObject<mk_gw_mqttModifyNetworkProtocol>
...
@implementation MKGWWifiNetworkSettingModel
...
@interface MKGWMqttWifiSettingsModel ()
...
@implementation MKGWMqttWifiSettingsModel
...
- (BOOL)configWifiNetworkInfos {
    __block BOOL success = NO;
    MKGWWifiNetworkSettingModel *settingModel = [[MKGWWifiNetworkSettingModel alloc] init];
