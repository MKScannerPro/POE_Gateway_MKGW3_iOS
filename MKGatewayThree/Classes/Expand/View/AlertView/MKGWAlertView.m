...
@implementation MKGWAlertViewModel
@end

@interface MKGWAlertView ()
...
@implementation MKGWAlertView

- (void)dealloc {
    NSLog(@"MKGWAlertView销毁");
}
...
- (void)showWithModel:(MKGWAlertViewModel *)dataModel
         cancelAction:(void (^)(void))cancelBlock
        confirmAction:(void (^)(void))confirmBlock {
    if (!dataModel || ![dataModel isKindOfClass:MKGWAlertViewModel.class]) {
        return;
    }
