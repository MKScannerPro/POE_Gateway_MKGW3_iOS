...
@interface MKGWCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGWCommunicateModel *dataModel;

@end

@implementation MKGWCommunicateController

- (void)dealloc {
    NSLog(@"MKGWCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWCommunicateController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWCommunicateModel alloc] init];
    }
    return _dataModel;
}
