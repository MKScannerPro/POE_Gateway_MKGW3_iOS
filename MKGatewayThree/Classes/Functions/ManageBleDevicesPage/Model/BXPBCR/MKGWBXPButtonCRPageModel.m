...
@implementation MKGWBXPButtonCRPageModel

- (void)dealloc {
    NSLog(@"MKGWBXPButtonCRPageModel销毁");
...
- (id <MKScannerRemoteReminderProtocol>)remoteReminderProtocol {
    return [[MKGWBXPButtonCRRemoteReminderModel alloc] init];
}

- (id <MKScannerAccDataProtocol>)accProtocol {
    return [[MKGWBXPButtonCRAccDataPageModel alloc] init];
}

- (id <MKScannerBXPButtonCRAlarmEventProtocol>)alarmEventProtocol {
    return [[MKGWBXPButtonCRAlarmEventModel alloc] init];
}

- (id <MKScannerBXPCAdvParamsProtocol>)advProtocol {
    return [[MKGWBXPButtonCRAdvParamsModel alloc] init];
}

- (void)clearEventCountWithType:(NSInteger)type
                       sucBlock:(void (^)(void))sucBlock
                    failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_clearBXPButtonCREventCountWithType:type
...
- (void)readConnectedStatusWithSucBlock:(void (^)(id returnData))sucBlock
                            failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_readBXPButtonCRConnectedStatusWithBleMacAddress:[MKGWManageBleDevicesManager shared].bleMac
                                                               macAddress:[MKScannerDeviceModelManager shared].macAddress
                                                                    topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                                                 sucBlock:sucBlock
                                                              failedBlock:failedBlock];
...
- (void)dismissBXPButtonCRAlarmStatusWithSucBlock:(void (^)(id returnData))sucBlock
                                      failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_dismissBXPButtonCRAlarmStatusWithBleMacAddress:[MKGWManageBleDevicesManager shared].bleMac
                                                              macAddress:[MKScannerDeviceModelManager shared].macAddress
                                                                   topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                                                sucBlock:sucBlock
                                                             failedBlock:failedBlock];
...
- (void)powerOffWithSucBlock:(void (^)(id returnData))sucBlock
                 failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGWMQTTInterface gw_bxpBtnCRRemotePowerOffWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                macAddress:[MKScannerDeviceModelManager shared].macAddress
                                                     topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                                  sucBlock:sucBlock
                                               failedBlock:failedBlock];
