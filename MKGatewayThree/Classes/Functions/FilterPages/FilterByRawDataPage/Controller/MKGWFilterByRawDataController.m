//
//  MKGWFilterByRawDataController.m
...
@property (nonatomic, strong)MKGWFilterByRawDataModel *dataModel;

@end

@implementation MKGWFilterByRawDataController

- (void)dealloc {
    NSLog(@"MKGWFilterByRawDataController销毁");
}
...
- (MKGWFilterByRawDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWFilterByRawDataModel alloc] init];
    }
    return _dataModel;
}
