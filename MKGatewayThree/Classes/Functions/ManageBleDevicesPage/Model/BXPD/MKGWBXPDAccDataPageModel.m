...
@implementation MKGWBXPDAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGWBXPDAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGWMQTTInterface gw_bxpBXPDNotifyAccDataWithBleMac:[MKGWManageBleDevicesManager shared].bleMac
                                                  notify:isOn
