...
@implementation MKGWBXPSAdvNormalCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKGWBXPSAdvNormalCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKGWBXPSAdvNormalCell ()
...
@implementation MKGWBXPSAdvNormalCell

+ (MKGWBXPSAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKGWBXPSAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGWBXPSAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKGWBXPSAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGWBXPSAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKGWBXPSAdvNormalCellSlotTypeNoData) {
...
#pragma mark - setter
- (void)setDataModel:(MKGWBXPSAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGWBXPSAdvNormalCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKGWBXPSAdvNormalCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKGWBXPSAdvNormalCellSlotType)slotType {
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKGWBXPSAdvNormalCellSlotTypeTHInfo) {
        return @"T&H info";
    }
