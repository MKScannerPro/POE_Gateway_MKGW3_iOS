...
@interface MKGWPirSensorDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWPirSensorDataController

- (void)dealloc {
    NSLog(@"MKGWPirSensorDataController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_notifyMKPirSensorDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
