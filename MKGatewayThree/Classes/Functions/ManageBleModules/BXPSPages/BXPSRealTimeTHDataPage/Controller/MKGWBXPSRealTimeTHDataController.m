//
//  MKGWBXPSRealTimeTHDataController.m
...
@interface MKGWBXPSRealTimeTHDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGWBXPSRealTimeTHDataController

- (void)dealloc {
    NSLog(@"MKGWBXPSRealTimeTHDataController销毁");
...
- (void)gw_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGWMQTTInterface gw_bxpBXPSNotifyRealTimeHTDataWithBleMac:self.bleMac notify:isOn macAddress:[MKScannerDeviceModelManager shared].macAddress topic:[MKScannerDeviceModelManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
