...
@interface MKGWReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGWReconnectTimeModel *dataModel;

@end

@implementation MKGWReconnectTimeController

- (void)dealloc {
    NSLog(@"MKGWReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayThree", @"MKGWReconnectTimeController", @"gw_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGWReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGWReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
